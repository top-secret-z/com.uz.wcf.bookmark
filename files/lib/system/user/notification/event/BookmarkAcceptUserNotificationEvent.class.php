 ...
 */
class BookmarkAcceptUserNotificationEvent extends AbstractUserNotificationEvent {
	/**
	 * @inheritDoc
	 */
	public function getTitle() {
		return $this->getLanguage()->get('wcf.user.notification.bookmark.accept.title');
	}
	...
	public function getMessage() {
		...
		return $this->getLanguage()->getDynamicVariable('wcf.user.notification.bookmark.accept.message', [
				'author' => $this->author,
